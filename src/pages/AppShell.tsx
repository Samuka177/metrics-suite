...
type Tab = 'rotas' | 'motoristas' | 'nfe' | 'relatorios';
          ...
          {tabs.map(t => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 px-3 py-2 transition-colors ${active ? 'text-primary' : 'text-muted-foreground'}`}
              >
